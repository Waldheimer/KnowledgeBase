...
{
    public class SnippetService : IDataService<CreateCSD_DTO, ReadCSD_DTO, UpdateCSD_DTO, Guid>
    {
        private readonly KB_DataContext _context;

        public SnippetService(KB_DataContext context)
        {
            _context = context;
        }

        /// <summary>
        /// Creates the Snippet, the Descriptor and the Description and connects 
        /// them together with ONE Guid
        /// </summary>
        /// <param name="item">
        /// Contains all information to create Snippet and Descriptor with optional Description
        ...
        public string CreateEntry(CreateCSD_DTO item)
        {
            ...
            Snippet snippet = Snippet.fromCreateCSD_DTO(guid, item);
            try
            {
        ...
        /// <summary>
        /// Gets the Snippet with Decriptor and Description with given ID
        /// </summary>
        /// <param name="id"></param>
        /// <returns>
        /// A ReadCSD_DTOs that's a combined Snippet/Descriptor/Description
        /// with matching ID
        /// </returns>
        public IEnumerable<ReadCSD_DTO> GetEntryById(Guid id)
        {
            var snippet = _context.Snippets.First(c => c.Descriptor == id);
        ...
        /// <summary>
        /// Just returns all Snippets if no Guid is given
        /// </summary>
        /// <returns></returns>
        public IEnumerable<ReadCSD_DTO> GetEntries()
        {
            return from snippet in _context.Snippets
                   from descriptor in _context.Descriptors
                   from description in _context.Descriptions
                   where descriptor.ID.Equals(snippet.Descriptor) && description.ID.Equals(snippet.Descriptor)
        ...
        /// <summary>
        /// Gets all Snippets with Decriptors and Descriptions by 'Lang'-Attribute
        /// </summary>
        /// <param name="lang">The specified Lang(guage) Attribute in the Descriptor</param>
        /// <returns>
        /// A List of ReadCSD_DTOs which are combined Snippet/Descriptor/Description
        /// with matching ID
        /// </returns>
        public IEnumerable<ReadCSD_DTO> GetEntriesByLang(string lang)
        {
            var results = (from ds in _context.Descriptors
                           ...
                           from data in _context.Snippets
        ...
        /// <summary>
        /// Gets all Snippets with Decriptors and Descriptions by 'System'-Attribute
        /// </summary>
        /// <param name="system">The specified System Attribute in the Descriptor</param>
        /// <returns>
        /// A List of ReadCommandDTOs which are combined Snippet/Descriptor/Description
        /// with matching ID
        /// </returns>
        ...
        /// <summary>
        /// Gets all Snippets with Decriptors and Descriptions by 'Tech'-Attribute
        /// </summary>
        ...
        /// <summary>
        /// Updates a Snippet and/or the corresponding Descriptor/Description
        /// </summary>
        ...
        /// <summary>
        /// Deletes the Snippet/Descriptor/Description with given ID from the DB
        /// </summary>
        /// <param name="id"></param>
        /// <returns>Operation Success</returns>
        public bool DeleteEntry(string id)
        {
            ...
            try
            {
                _context.Remove<Snippet>(_context.Snippets.First(c => c.Descriptor.ToString().Equals(id)));
